...
{
    [SerializeField] private float dumping = 2f;
    ...
    private void FindPlayer()
    {
        ...
        _lastX = Mathf.RoundToInt(transform.position.x);
    ...
    private void LateUpdate()
    {
        ...
        transform.position = Vector2.Lerp(transform.position, target, dumping * Time.deltaTime);
    }
}
